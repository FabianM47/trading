...
const FIELDS: SelectorField[] = [
  {
    ...
    required: true,
    help: 'CSS-Selektor für den Artikel-Container. Jedes passende Element wird als ein Artikel behandelt.',
  },
  {
    key: 'title',
    label: 'Titel',
    placeholder: 'h2 a',
    required: true,
    help: 'CSS-Selektor für den Artikel-Titel innerhalb des Containers.',
  },
  {
    key: 'summary',
    ...
    required: false,
    help: 'CSS-Selektor für die Artikel-Zusammenfassung oder Beschreibung.',
  },
  {
    key: 'date',
    label: 'Datum',
    ...
    required: false,
    help: 'CSS-Selektor für das Veröffentlichungsdatum. Wenn das Element ein datetime-Attribut hat, wird dieses bevorzugt.',
  },
  {
    key: 'link',
    label: 'Link',
    ...
    required: false,
    help: 'CSS-Selektor für den Artikel-Link. Falls leer, wird der Link aus dem Titel-Element extrahiert.',
  },
  {
    key: 'image',
    label: 'Bild',
    ...
    required: false,
    help: 'CSS-Selektor für das Artikel-Vorschaubild.',
  },
];
